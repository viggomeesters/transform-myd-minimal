...
from transform_myd_minimal.reporting import profile_series, profile_dataframe, write_html_report
...
def test_profile_series_string():
    ...
    assert profile["unique"] == 4  # apple, banana, cherry, "  apple  " (whitespace treated as separate)
